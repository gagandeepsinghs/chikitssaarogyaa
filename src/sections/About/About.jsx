...
const About = () => {
  ...
  const [expandedPeriod, setExpandedPeriod] = useState('2025-present');
  ...
  const accordionData = [
    ...
    },
    {
      id: "2021-2024",
      period: "2021 – 2024",
      title: "Expansion & Specialized Care",
      milestones: [
    ...
    },
    {
      id: "2025-present",
      period: "2025 – Present",
      title: "Holistic & Developmental Care",
      milestones: [
            ...
            <div className="about-panel journey-panel animate-fade-in">
              ...
              <div className="about-accordion">
                {accordionData.map((group) => {
                  const isOpen = expandedPeriod === group.id;
                  return (
                    <div 
                      key={group.id} 
                    ...
                    >
                      <button 
                        ...
                        onClick={() => setExpandedPeriod(isOpen ? null : group.id)}
                        aria-expanded={isOpen}
                      >
                        <div className="header-content">
                          <span className="accordion-period">{group.period}</span>
                      ...
                      <div className={`accordion-collapse ${isOpen ? 'show' : ''}`}>
                        <div className="accordion-body">
                          {group.milestones.map((item, idx) => (
                            <div key={idx} className="accordion-milestone">
